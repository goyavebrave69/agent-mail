...
export default async function SettingsPage({ searchParams }: SettingsPageProps) {
  ...
  const successMessage =
    resolvedParams.connected === "gmail" ? "Gmail account connected successfully." : null
  const errorMessage =
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-12">
      ...
      <Suspense fallback={<div className="mb-8 h-28 rounded-lg border p-6 animate-pulse bg-muted" />}>
        <ConnectedAccounts />
      </Suspense>
